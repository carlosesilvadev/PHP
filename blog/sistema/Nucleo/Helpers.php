...
class Helpers{
    ...
    public static function saudacao(): string {
        #https://www.php.net/manual/pt_BR/public static function.date-default-timezone-get.php
        #TimeZone setada para evitar erro de timezone diferente daqui de São Paulo
        date_default_timezone_set('America/Sao_Paulo');

        #https://www.php.net/manual/pt_BR/public static function.date.php - Função date
        $hora = date('H');
     ...
     */
    public static function cortarTexto(string $texto, int $limite, string $etc = '...'): string{
    ...
    public static function limparCPF(string $numero): string{
